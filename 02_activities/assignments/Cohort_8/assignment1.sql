...
WHERE product_id = '4' OR product_id = '9'; -- there are no product_id with value = 9
...
*/
-- option 1
SELECT customer_id, (quantity*cost_to_customer_per_qty) AS total_price --(quantity*cost_to_customer_per_qty) as total_price -- calc price
FROM customer_purchases 
WHERE customer_id >= 8 AND customer_id <=10; -- i used the > and < to limit it to 2 conditions  
